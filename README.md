...
**DOGE contract termination data (excel)**
  ...
  Access Method: [download link]([https://iq.govwin.com/neo/marketAnalysis/view/Tracking-Terminated-Contracts/8224?researchTypeId=1](https://www.sba.gov/federal-contracting/contracting-data/small-business-procurement-scorecard/scorecard-details))  
  Files located in `/data/` folder  
